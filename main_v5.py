...
def draw_houseX():
    midPointAlgo(200, 200, 340, 200)
    midPointAlgo(200,200, 200,270)
    
    midPointAlgo(340,200, 340,270)
    midPointAlgo(200,270, 340,270)
    midPointAlgo(200,270, 270,340)
    midPointAlgo(340,270, 270,340)
    midPointAlgo(270,340, 200,270)
